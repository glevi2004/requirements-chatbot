...
function Sidebar({
  ...
  // Use sidebarItems directly instead of accepting as prop
  const content = (
    <>
...
function SidebarContent({ className, ...props }) {
  return (
    <div
      ...
      className={cn(
        "pt-8 flex min-h-0 flex-1 flex-col gap-2 overflow-auto group-data-[collapsible=icon]:overflow-hidden",
        className
      )}
      {...props}
    />
